...
class Messages:
    ...
    START_MSG = """Hello,
I am Telegram To YouTube Upload Bot! Created by @shreevish
Please send me any Telegram File/Video, I can upload to Youtube ! 

       ┈┈┈••💙✿❤️✿💚••┈┈┈
🚨 . . . Note :-  To use me /help and --> then again--> then--> after verify your account --> and then Authentication URL
allow and send me the copied string as /aith string then u can upload bu replying a video /upload
...
➼/upload = Reply To Upload to Youtube !
➼/aith = To autherise me!
...
⚠️Note :- Join My Channel before paste the link"""
    ...
    NOT_A_VALID_MEDIA_MSG = "⚠️ This is not a valid media"
